...
namespace SuperScrollView
{
    ...
    public class LoopListView2 : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        public bool isListSnapFinish()
        {
            if (mCurSnapData != null && mCurSnapData.mSnapStatus == SnapStatus.SnapMoveFinish)
            {
                return true;
            }
            return false;
        ...
        public bool IsMovingShieldOperate
        {
            get{
                if (mCurSnapData == null)
                {
                    return false;
                }
                ...
                if (mCurSnapData.mSnapStatus == SnapStatus.SnapMoving &&
                    Mathf.Abs(mCurSnapData.mTargetSnapVal - mCurSnapData.mCurSnapVal) > 100f)
                {
                    return true;
                }
